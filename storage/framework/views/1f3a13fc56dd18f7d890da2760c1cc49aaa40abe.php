            ...
            <div class="col-lg-6 col-md-6">
                <div class="infotechno-hero-inner-images">
                    ...
                    <div class="infotechno-inner-two  wow move-up">
                        <img class="img-fluid" src="<?php echo e(asset('assets/images/gallery/bgimage.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="rv-video-section">
                    <div class="main-video-box video-popup">
                        <a href="<?php echo e(asset('assets/promo/promo.mp4')); ?>" class="video-link  mt-30">
                            
                            <div class="single-popup-wrap">
                                <img class="img-fluid border-radus-5" src="<?php echo e(asset('assets/full-width-img/doctor.jpg')); ?>" alt="">
                ...
                <div class="col-lg-6">
                    <div class="slide-image">
                        <div class="image-wrap">
                            <div class="image">
                                <img class="img-fluid" src="<?php echo e(asset('assets/images/gallery/doctors.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 wow move-up mt-5 ">
                <center>
                    ...
                    <img src="<?php echo e(asset('assets/images/icons/ezgif.com-webp-to-png.png')); ?>" width="80" height="80" ><br><br>
            ...
            <div class="col-lg-4 col-md-6 wow move-up mt-5">
                <center>
                    ...
                    <img src="<?php echo e(asset('assets/images/icons/padlock.png')); ?>" width="80" height="80"><br><br>
                </center>
            </div>
            <div class="col-lg-4 col-md-6 wow move-up mt-5">
                <center>
                    <h5 class="heading">Training & Support</h5><br>
                    <img src="<?php echo e(asset('assets/images/icons/customer-service.png')); ?>" width="80" height="80"><br><br>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-widget__logo mb-30">
                        <img src="<?php echo e(asset('assets/images/gallery/promo-2.png')); ?>" alt="" style="width: 390px">
                    </div>
                </div>
                                    ...
                                    <div class="box-large-image__box">
                                        <div class="box-large-image__midea">
                                            <div class="images-midea">
                                                <img src="<?php echo e(asset('assets/img/team/team-1.jpg')); ?>" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-3 col-md-6 mt-30">
                                ...
                                <a href="#" class="box-large-image__wrap wow move-up">
                                    <div class="box-large-image__box">
                                        <div class="box-large-image__midea">
                                            <div class="images-midea">
                                                <img src="<?php echo e(asset('assets/img/team/team-2.jpg')); ?>" class="img-fluid" alt="">
                                                <div class="button-wrapper">
                                                    <div class="btn tm-button">
                            ...
                            <div class="col-lg-3 col-md-6 mt-30">
                                ...
                                <a href="#" class="box-large-image__wrap wow move-up">
                                    <div class="box-large-image__box">
                                        <div class="box-large-image__midea">
                                            <div class="images-midea">
                                                <img src="<?php echo e(asset('assets/img/team/team-3.jpg')); ?>" class="img-fluid" alt="">
                                                <div class="button-wrapper">
                                                    <div class="btn tm-button">
...
<div class="mt-5">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/shincs7l/vistadermsolutions.com/resources/views/home.blade.php ENDPATH**/ ?>